...
export default function Drawer({ session, children }: MyComponentProps) {
  return (
    <div className="drawer drawer-end">
      ...
      <div className="drawer-side ">
        ...
        <ul className="menu p-4 w-80 min-h-full text-primary font-semibold gap-3 bg-neutral pt-32">
          <Menu />
          <div className="flex bg-white rounded-lg p-2 w-full">
            <svg
              className="w-6"
              viewBox="0 0 24 24"
              fill="none"
