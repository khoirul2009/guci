...
export default function Navbar() {
  return (
    <div
      className={`navbar lg:px-36  top-0 w-full  transition-all duration-300 bg-neutral text-white fixed z-[9999]`}
    >
      ...
      <div className="flex-none hidden lg:block ">
        <ul className="menu menu-horizontal px-1 gap-3 text-primary">
          <Menu />
        </ul>
      </div>
